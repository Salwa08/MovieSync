...
from .views import FilmList, popular_movies, search_content, get_popular_movies, list_favourites, add_favourite, remove_favourite, FilmDetail, FilmReviewListCreateView, ReviewDeleteView, movie_recommendations    
