      ...
      >
        ...
        <div className="absolute left-4 top-20 md:left-20 right-0 p-10 bg-gradient-to-t from-black to-transparent ">
          <div className="max-w-2xl ">
            <h1 className=" text-4xl md:text-5xl font-bold tracking-wider md:tracking-widest mb-4 md:mb-2">{movie?.Titre}</h1>
            ...
            <div className="flex gap-4">
              <a href={movie?.Trailer} target="_blank" rel="noopener noreferrer" className="hidden md:block">
              ...
              {/*mobile*/ }
              <a href={movie?.Trailer} target="_blank" rel="noopener noreferrer" className="md:hidden">
